...
Alright, that's it for now. Next week we'll combine that chunk system from [last weeks post](https://minoqi.vercel.app/posts/coordinate-based-chunk-checking-in-godot-4/) with out poisson disc sampling algorithm! Please look forward to it :) If you'd like to support me you can get the project files [here](https://minoqi.itch.io/).